...
export function evaluateQuizData() {
    ...
    if (Object.entries(correctlyAnswered).length > 0 && $('.b-quiz-question[data-type="success"] .e-result').length > 0) {
        ...
        $('.b-quiz-question[data-type="success"] .e-result').text(result);
    }
}

...
<div
    id="<?php echo $id ?>"
    class="<?php echo $quiz_wrapper_classes ?>"
    data-quiz-post-id="<?php echo $quiz_data['quiz_id'] ?>"
    data-quiz-type="<?php echo $quiz_data['quiz_type'] ?>"
    data-cor-trigger="<?php echo $quiz_data['correct_answer_trigger'] ?>"
    data-quiz-slug="<?php echo $quiz_data['quiz_slug'] ?>"
>
            ...
            >
                <div class="growtype-quiz-inner">
                    ...
                    <?php if (isset($quiz_data['show_quiz_header']) && $quiz_data['show_quiz_header']) { ?>
                        <?php ob_start(); ?>
                            ...
                            <?php if (isset($quiz_data['progress_bar']) && $quiz_data['progress_bar']) { ?>
                                <?php echo growtype_quiz_include_view('quiz.partials.components.progress-bar', ['quiz_data' => $quiz_data]); ?>
                            <?php } ?>
                    ...
                    if (isset($quiz_data['questions']) && !empty($quiz_data['questions'])) {
                        $index = 0;
                        $questions = array_values($quiz_data['questions']);
                        foreach ($questions as $key => $question) {
                            ...
                            if (!$disabled) { ?>
                                <div class="<?php echo $question_classes ?>"
                                     ...
                                     data-question-title="<?php echo isset($question['has_question_title']) && $question['has_question_title'] && isset($question['question_title']) ? $question['question_title'] : '' ?>"
                    ...
                    <?php do_action('growtype_quiz_inner_before_close', $quiz_data) ?>
                </div>
            </div>
        </div>
    </div>
